const Message = () => {
    return (
        <div className="absolute shadow-2xl top-[15%] sm:top-[2%] md:top-[5%] left-[8%] sm:left-[27%] md:left-[25%] lg:left-[20%] z-50 lg:w-96 bg-tertiary-dark p-4 sm:p-5 rounded-2xl border-2 border-[#2c2c2c] before:content-[' '] before:absolute before:w-0 before:h-0 after:content-[' '] after:absolute after:w-0 after:h-0 
